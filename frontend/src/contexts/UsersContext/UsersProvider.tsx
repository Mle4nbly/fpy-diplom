...
export const UsersProvider = ({children}: {children: ReactNode}) => {
  ...
  const {loading, error, getData, sendData} = useApi<UserType>(token);
  ...
  return (
    <UsersContext.Provider value={{users, loading, error, getUsersList, deleteUser, changeUserRights}}>
      {children}
